...
const SETTINGS_SCHEMA = {
  ...
  ollama: {
    ...
    requiresRestart: true,
    default: {},
    description: 'Settings for Ollama local AI model integration.',
    showInDialog: false,
    properties: {
      baseUrl: {
        type: 'string',
        ...
        description: 'The base URL for the Ollama API server.',
        showInDialog: true,
      },
      model: {
        type: 'string',
        ...
        requiresRestart: true,
        default: undefined as string | undefined,
        description: 'The Ollama model to use (e.g., llama2, codellama, mistral).',
        showInDialog: true,
      },
      enableChatApi: {
        type: 'boolean',
        ...
        requiresRestart: true,
        default: true,
        description: 'Use the Ollama Chat API instead of the Generate API.',
        showInDialog: true,
      },
      chatTimeout: {
        type: 'number',
      ...
      contextLimit: {
        ...
        requiresRestart: false,
        default: 8192,
        description: 'Maximum context size for conversation tracking.',
        showInDialog: true,
      },
      requestContextSize: {
        type: 'number',
        label: 'Request Context Size',
        category: 'Ollama',
        requiresRestart: false,
        default: 8192,
        description: 'Context size per request sent to Ollama.',
        showInDialog: true,
      },
      temperature: {
        type: 'number',
      ...
      debugLogging: {
        ...
        requiresRestart: false,
        default: false,
        description: 'Enable detailed debug logging for Ollama requests.',
        showInDialog: true,
      },
    },
  },
